...
(function () {
  ...
  try { I.reg && I.reg({
    ...
    'resv.no.slots':        { de:'Für dieses Datum sind aktuell keine Reservierungszeiten verfügbar (geschlossen oder zu kurzfristig).',
                              en:'No reservation times available for this date (closed or too short notice).' },
    ...
    'resv.success.body':    { de:'Danke für deine Anfrage! Schau bitte in dein E-Mail-Postfach – wir melden uns kurz zurück.',
                              en:'Thanks for your request! Please check your inbox—we’ll get back to you shortly.' },

    'resv.error.title':     { de:'SENDEN FEHLGESCHLAGEN', en:'SENDING FAILED' },
    'resv.error.why':       { de:'Uff, das hat gerade nicht geklappt. Grund (technisch): {msg}',
                              en:'Oops, that didn’t work. Technical reason: {msg}' },
    'resv.error.try':       { de:'Du kannst es nochmal versuchen oder deine E-Mail-App manuell öffnen.',
